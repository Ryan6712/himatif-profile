...
export const actions: Actions = {
    default: async ({ request, params }) => {
        ...
        if (!memberTypeRaw || !Object.values(member_memberType).includes(memberTypeRaw as member_memberType)) {
        ...
        const devisiId = (devisiIdRaw && memberType !== "BPH" && memberType !== "ALUMNI") ? Number(devisiIdRaw) : null;
