...
<svelte:head>
	<title>Tambah Anggota - Admin HIMATIF</title>
</svelte:head>
...
<div class="stack-lg flex max-w-4xl flex-col">
	<div class="flex items-center gap-4 border-b border-primary/10 pb-4">
		...
		<div>
			<h1 class="text-3xl font-extrabold tracking-tight text-title-text">Tambah Anggota</h1>
			<p class="text-sm text-primary-text opacity-80">Tambahkan anggota kepengurusan HIMATIF.</p>
		</div>
	</div>
